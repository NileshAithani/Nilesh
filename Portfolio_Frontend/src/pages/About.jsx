      ...
      <div className="flex justify-center items-center pt-32">
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-16">
          <div className="flex-1  text-slate-400 text-base md:text-lg px-4 md:px-0 max-w-2xl">
            <h1 className="text-white text-6xl pb-7 font-bold font-ntr">
              / about me
            </h1>
            {oneDesc}
          ...
          <div className="flex-1 text-center md:text-left max-w-sm">
            <img
              src={my}
              alt="Nilesh"
              className="max-w-[290px] h-auto rounded-lg shadow-lg transition-transform duration-300 ease-in-out hover:scale-105"
            />
          </div>
        </div>
      </div>
